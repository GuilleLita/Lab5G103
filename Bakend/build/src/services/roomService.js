...
let RoomService = class RoomService {
    constructor(roomRepo, logger) {
        this.roomRepo = roomRepo;
        this.logger = logger;
    }
    async CreateRoom(roomDTO) {
        const RoomOrError = await room_1.Room.create({
        ...
        if (RoomOrError.isFailure) {
            throw Result_1.Result.fail(RoomOrError.errorValue());
        }
        ...
        return Result_1.Result.ok({ roomDTO: RoomDTOResult });
    }
};
